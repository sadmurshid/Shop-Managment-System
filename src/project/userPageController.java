...
//            scene.getStylesheets().add(getClass().getResource("style.css").toExternalForm());
    ...
    @FXML
    public void setUserPageInventoryButton(){
        try{
            FXMLLoader loader=new FXMLLoader(getClass().getResource("inventory.fxml"));
            AnchorPane pane = loader.load();
            borderPaneCenterGridpane.add(pane, 0, 1);
    ...
    @FXML
    public void setUserPageBuyProductButton(){
        try{
            FXMLLoader loader=new FXMLLoader(getClass().getResource("buyProduct.fxml"));
            AnchorPane pane = loader.load();
            borderPaneCenterGridpane.add(pane, 0, 1);
            borderPaneUserPage.setCenter(borderPaneCenterGridpane);
